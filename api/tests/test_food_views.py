...
class FoodsEndpointTest(TestCase):
    ...
    def test_gets_all_foods(self):
        ...
        self.assertEqual(response[0]["name"], self.apple.name)
        self.assertEqual(response[0]["calories"], self.apple.calories)
        self.assertEqual(response[1]["name"], self.ramen.name)
        self.assertEqual(response[1]["calories"], self.ramen.calories)
    ...
    def test_gets_first_single_food_response(self):
        ...
        self.assertEqual(food_response["name"], self.apple.name)
        self.assertEqual(food_response["calories"], self.apple.calories)
